...
from ovos_mk2_enclosure.network_utils import connected
from ovos_mk2_enclosure.hardware_enclosure import HardwareEnclosure
...
class EnclosureMark2(EnclosureTemplate):
    def __init__(self):
